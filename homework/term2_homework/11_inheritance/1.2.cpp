...
{
    Circle a({0, 0}, 10);
    cout << "Исходное положение круга: " << a.getPosition() << endl;
    a.move({5, 5}); 
    cout << "Новое положение круга: " << a.getPosition() << endl;

    Rectangle b({0, 0}, 100, 200);
    cout << "Исходное положение прямоугольника: " << b.getPosition() << endl;
    b.move({10, 10}); 
    cout << "Новое положение прямоугольника: " << b.getPosition() << endl;

    Triangle c({0, 0}, {5, 2}, {-7, 5}, {4, 4});
    cout << "Исходное положение треугольника: " << c.getPosition() << endl;
    c.move({-5, -5}); 
    cout << "Новое положение треугольника: " << c.getPosition() << endl;
}
